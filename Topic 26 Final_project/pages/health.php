        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <img style="border-radius: 10px;" src="../images/health/02.jpg" height="100px" width="100px" alt="">
                    </div>
                    <div class="col-md-8">
                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ea, libero? Expedita at accusamus vero necessitatibus ipsum, ullam adipisci eligendi veniam ipsa similique </p>
                    </div>
                    <div class="col-md-4">
                        <img style="border-radius: 10px;" src="../images/health/03.jpg" height="100px" width="100px" alt="">
                    </div>
                    <div class="col-md-8">
                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ea, libero? Expedita at accusamus vero necessitatibus ipsum, ullam adipisci eligendi veniam ipsa similique </p>
                    </div>
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <img style="border-radius: 10px;" src="../images/health/04.jpg" height="90%" width="100%" alt="">
                    </div>
                    <div class="col-md-8">
                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ea, libero? Expedita at accusamus vero necessitatibus ipsum, ullam adipisci eligendi veniam ipsa similique </p>
                    </div>
                    <div class="col-md-4">
                        <img style="border-radius: 10px;" src="../images/health/05.jpg" height="90%" width="100%" alt="">
                    </div>
                    <div class="col-md-8">
                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ea, libero? Expedita at accusamus vero necessitatibus ipsum, ullam adipisci eligendi veniam ipsa similique </p>
                    </div>
                    <div class="col-md-4">
                        <img style="border-radius: 10px;" src="../images/health/06.jpeg" height="90%" width="100%" alt="">
                    </div>
                    <div class="col-md-8">
                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ea, libero? Expedita at accusamus vero necessitatibus ipsum, ullam adipisci eligendi veniam ipsa similique </p>
                    </div>
            ...
            <div class="col-md-6">
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <img style="border-radius: 10px;" src="../images/health/07.png" height="90%" width="100%" alt="">
                    </div>
                    <div class="col-md-8">
                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ea, libero? Expedita at accusamus vero necessitatibus ipsum, ullam adipisci eligendi veniam ipsa similique </p>
                    </div>
                    ...
                    <div class="col-md-4">
                        <img style="border-radius: 10px;" src="../images/health/09.jpeg" height="90%" width="100%" alt="">
                    </div>
                    <div class="col-md-8">
                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ea, libero? Expedita at accusamus vero necessitatibus ipsum, ullam adipisci eligendi veniam ipsa similique </p>
                    </div>
