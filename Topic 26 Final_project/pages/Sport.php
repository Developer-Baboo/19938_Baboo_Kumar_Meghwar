                ...
                <div id="carouselExampleAutoplaying" class="carousel slide" data-bs-ride="carousel">
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img src="../images/sport/1.jpg" class="d-block w-100" alt="No Images" style="height:540px;">
                        </div>
                        <div class="carousel-item">
                            <img src="../images/sport/2.jpg" class="d-block w-100" alt="No Image" style="height:540px;">
                        </div>
                        <div class="carousel-item">
                            <img src="../images/sport/3.jpg" class="d-block w-100" alt="No Image" style="height:540px;">
                        </div>
                    </div>
