        ...
        <div class="row">
                ...
                <div id="carouselExampleAutoplaying" class="carousel slide" data-bs-ride="carousel">
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img style="border-radius: 20px;" src="../images/buisness/1.jpg" class="d-block w-100" alt="No Images" style="height:10px;">
                        </div>
                        <div class="carousel-item">
                            <img style="border-radius: 20px;" src="../images/buisness/2.jpg" class="d-block w-100" alt="No Image" style="height:440px;">
                        </div>
                        <div class="carousel-item">
                            <img style="border-radius: 20px;" src="../images/buisness/3.jpg" class="d-block w-100" alt="No Image" style="height:440px;">
                        </div>
                    </div>
            ...
            <div class="col-md-4">
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <img style="border-radius: 10px;" src="../images/buisness/01.jpg" height="100px" width="100px" alt="">
                    </div>
                    <div class="col-md-8">
                    ...
                    <div class="col-md-4">
                        <img style="border-radius: 10px;" src="../images/buisness/02.jpeg" height="100px" width="100px" alt="">
                    </div>
                    <div class="col-md-8">
                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ea, libero? Expedita at accusamus vero necessitatibus ipsum, ullam adipisci eligendi veniam ipsa similique </p>
                    </div>
                    <div class="col-md-4">
                        <img style="border-radius: 10px;" src="../images/buisness/03.jpeg" height="100px" width="100px" alt="">
                    </div>
                    <div class="col-md-8">
                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ea, libero? Expedita at accusamus vero necessitatibus ipsum, ullam adipisci eligendi veniam ipsa similique </p>
                    </div>
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <img style="border-radius: 10px;" src="../images/buisness/05.jpg" height="90%" width="100%" alt="">
                    </div>
                    <div class="col-md-8">
                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ea, libero? Expedita at accusamus vero necessitatibus ipsum, ullam adipisci eligendi veniam ipsa similique </p>
                    </div>
                    <div class="col-md-4">
                        <img style="border-radius: 10px;" src="../images/buisness/06.jpg" height="90%" width="100%" alt="">
                    </div>
                    <div class="col-md-8">
                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ea, libero? Expedita at accusamus vero necessitatibus ipsum, ullam adipisci eligendi veniam ipsa similique </p>
                    </div>
            ...
            <div class="col-md-6">
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <img style="border-radius: 10px;" src="../images/buisness/07.jpeg" height="70%" width="100%" alt="">
                    </div>
                    <div class="col-md-8">
                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ea, libero? Expedita at accusamus vero necessitatibus ipsum, ullam adipisci eligendi veniam ipsa similique </p>
                    </div>
                    ...
                    <div class="col-md-4">
                        <img style="border-radius: 10px;" src="../images/buisness/09.jpg" height="90%" width="100%" alt="">
                    </div>
                    <div class="col-md-8">
                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ea, libero? Expedita at accusamus vero necessitatibus ipsum, ullam adipisci eligendi veniam ipsa similique </p>
                    </div>
