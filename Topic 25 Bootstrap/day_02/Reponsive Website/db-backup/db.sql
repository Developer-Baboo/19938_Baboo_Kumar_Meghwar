...
MySQL - 10.4.28-MariaDB : Database - blog_management_system
*********************************************************************
*/
...
(9,2,'What is Science ?','Science is a systematic endeavor that builds and organizes knowledge in the form of testable explanations and predictions about the universe. The earliest written records of identifiable predecessors to modern science come from Ancient Egypt and Mesopotamia from around 3000 to 1200 BCE','Active'),
...
insert  into `users`(`user_id`,`full_name`,`gender`,`user_email`,`user_password`,`is_active`,`permission`) values 
(1,'Admin Hidaya','Male','admin@gmail.com','12345','Active',0),
(2,'Author Nazir','Male','author_nazir@gmail.com','12345','Active',1),
(3,'Saba','Female','saba_user@gmail.com','12345','Active',1),
(4,'Ali','Male','ali@gmai.com','12345','Active',1),
(5,'Baboo Kumar','Male','babooheerani999@gmail.com','123456789','Active',1),
(6,'Mohan Lal','Male','mohanheerani@gmail.com','12345','Active',1),
(7,'Faria Shaikh','Female','faria@gmail.com','12345','Active',1),
(8,'Author Baboo Kumar','Male','baboo123@gmail.com','12345','Active',1),
(9,'Author Muskan','Female','muskan@gmail.com','12345','Active',1),
(10,'Seeta','Male','seeta@gmail.com','12345','Active',1),
(11,'Bakhtawar','Female','bakhtawar@gmail.com','12345','Active',1),
(12,'Munesh','Male','munesh12@gmail.com','12345','Active',1),
(13,'Developer Kelash','Male','kelash@gmail.com','12345','Active',0);
