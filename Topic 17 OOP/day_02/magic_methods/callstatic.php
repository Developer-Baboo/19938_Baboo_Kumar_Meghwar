...
<body style="background-color:blue ; font-weight: bold; font-family: serif; color:white;font-size:20px; border: 5px solid purple; border-radius: 20px; padding: 30px 0px 20px 100px;">
