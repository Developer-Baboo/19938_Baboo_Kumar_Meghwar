    ...
    <div class="row">
        ...
        <div style="background-color:lightgreen" class="col-8">
            ...
            <div style="border:4px solid white;border-radius:10px;  margin:10px 50px 10px 5px; float:right ">
                <img style="text-align:center" src="../images/g2.png" alt="" height="100px" width="200px" alt="">
                <p>Name: ABC</p>
                <p>PRICE: 123</p>
                <span>
            ...
            <div style="border:4px solid white; border-radius:10px;margin:10px 50px 10px 5px;float:right ">
                <img src="../images/g3.png" alt="" height="100px" width="200px" alt="">
                <p>Name: ABC</p>
                <p>PRICE: 124</p>
                <span>
                    <input type="number" name="quantity" placeholder="Quantity">
            ...
            <div style="border:4px solid white; margin:10px 50px 10px 5px; border-radius:10px; float:right;">
                <img src="../images/g1.png" alt="" height="100px" width="200px" alt="">
                <p>Name: ABC</p>
                <p>PRICE: 125</p>
                <span>
                    <input type="number" name="quantity" placeholder="Quantity">
