		...
		<table id="post" border="1" width="100%">
			...
			?>
					<tr>
						...
						<td>
							<button><a style="text-decoration: none;" href="index.php?post_id=<?php echo $post['post_id']; ?>">
									Update
								</a></button>

							<!-- | -->
							<br> <br>
							<button><a style="text-decoration: none;" href="javascript:void(0)" post_id="<?php echo $post['post_id']; ?>" onclick="deletePost(this)">
									Delete
								</a></button>
